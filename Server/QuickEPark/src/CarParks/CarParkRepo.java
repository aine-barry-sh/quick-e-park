 ...
 */
    ...
    public int lookUpIndex(int i){
        return CarParks.get(i).getID();
    }
    ...
    public void addUserToCarPark(int carParkID, int userType){
        CarFace c = this.getCarPark(carParkID);
        c.newSession(userType);
    }
   ...
   public ArrayList<String> getCarParks(){
       ArrayList<String> carparks = new ArrayList();
       for (CarFace  aCarPark : CarParks) {
          carparks.add(aCarPark.getName());
       }
       return carparks;
   }
}
