 ...
 * @author aineb100
 */
public class ReservationBase implements Reservation{
    ...
    public ReservationBase(int user_id, int car_park_id, String time,int reservation_id, boolean complete) {
    ...
    public String toString() {
        return  this.user_id +","+this.car_park_id+","+ this.time + 
